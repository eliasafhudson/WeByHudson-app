              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-five border border-white/10 text-green text-sm rounded-xl pl-10 pr-4 py-3 placeholder:text-gray-600 focus:outline-none focus:border-four/60 transition-colors duration-200"
                  />
                </div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="w-full bg-five border border-white/10 text-green text-sm rounded-xl pl-10 pr-4 py-3 placeholder:text-gray-600 focus:outline-none focus:border-four/60 transition-colors duration-200 resize-none"
                  />
                </div>
